...
namespace Coalition
{
    public partial class ManagementPanel : System.Web.UI.Page
    {
        ...
        private static bool open7PlayersRoom = false;
                    ...
                    if (k <= i)
                    {
                        ...
                        switch (k)
                        {
                            ...
                            case 6:
                                ...
                                break;
                            case 7:
                                if (open7PlayersRoom && openWithAIroom)
                                    OpenNewRoom(7, "False", "true");
                                else if (open7PlayersRoom)
                                    OpenNewRoom(7, "False", "false");
                                break;
                            default:
                                break;
                        }
        ...
        protected void cbPlayers_CheckedChanged(object sender, EventArgs e)
        {
            ...
            open7PlayersRoom = cb7players.Checked;
